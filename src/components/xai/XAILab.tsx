        ...
        <div className="flex flex-wrap items-center justify-between pb-3 mb-2 border-b border-white/[0.08] text-xs font-mono-code">
          ...
          <div className="flex items-center gap-3 text-slate-400 text-[11px]">
            <span className="flex items-center gap-1">
              <span className="h-2 w-2 rounded-full bg-cyan-400" /> Ingress / Egress Attention
            </span>
            <span className="flex items-center gap-1">
              <span className="h-2 w-2 rounded-full bg-teal-400" /> Flat-Bottom Transit Core
            </span>
          </div>
        </div>
          ...
          <svg viewBox="0 0 700 200" className="w-full h-full select-none">
            <defs>
              <linearGradient id="attrGradient" x1="0" y1="0" x2="0" y2="1">
                ...
                <stop offset="50%" stopColor="#00e5a3" stopOpacity="0.4" />
            ...
            <text x="260" y="20" textAnchor="middle" className="font-mono-code text-[9px] fill-cyan-300 font-bold">
            ...
            <text x="460" y="20" textAnchor="middle" className="font-mono-code text-[9px] fill-cyan-300 font-bold">
              EGRESS GRADIENT PEAK
            </text>

            {/* X-Axis labels */}
            <text x="50" y="180" className="font-mono-code text-[9px] fill-slate-400" textAnchor="middle">-0.15 d</text>
            <text x="360" y="180" className="font-mono-code text-[9px] fill-slate-400" textAnchor="middle">Transit Center (0.0 d)</text>
            <text x="670" y="180" className="font-mono-code text-[9px] fill-slate-400" textAnchor="middle">+0.15 d</text>
            ...
            <text
              ...
              className="font-mono-code text-[9px] fill-slate-400 font-bold"
            >
              Attribution Weight
            </text>
          </svg>
        ...
        <div className="rounded-2xl cosmic-glass p-4 shadow-xl flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between pb-2 border-b border-white/[0.08] text-xs font-mono-code">
              ...
              <span className="text-[10px] text-cyan-400">Bottleneck: 64-dim</span>
            </div>
            ...
            <div className="relative my-3 h-52 w-full">
              <svg viewBox="0 0 280 260" className="w-full h-full select-none">
                ...
                <ellipse cx="205" cy="75" rx="55" ry="40" fill="rgba(0, 240, 255, 0.08)" stroke="rgba(0, 240, 255, 0.3)" strokeDasharray="3 3" />
                <text x="205" y="30" textAnchor="middle" className="font-mono-code text-[8px] fill-cyan-400 font-bold">
                  PLANET CANDIDATES
                </text>

                <ellipse cx="65" cy="195" rx="45" ry="35" fill="rgba(244, 63, 94, 0.08)" stroke="rgba(244, 63, 94, 0.3)" strokeDasharray="3 3" />
                <text x="65" y="245" textAnchor="middle" className="font-mono-code text-[8px] fill-rose-400 font-bold">
                  ECLIPSING BINARIES
                </text>
            ...
            <div className="my-3 space-y-3 font-mono-code text-xs">
              <div>
                <div className="flex justify-between text-slate-300 mb-1">
                  ...
                  <span className="text-cyan-400 font-bold">0.942</span>
                </div>
              ...
              <div>
                <div className="flex justify-between text-slate-300 mb-1">
                  ...
                  <span className="text-cyan-400 font-bold">0.887</span>
                </div>
                <div className="h-2 w-full rounded-full bg-slate-800 overflow-hidden">
                  <div className="h-full bg-teal-400 rounded-full" style={{ width: '88.7%' }} />
                </div>
              </div>
              ...
              <div>
                <div className="flex justify-between text-slate-300 mb-1">
                  ...
                  <span className="text-slate-400 font-bold">0.034</span>
                </div>
                <div className="h-2 w-full rounded-full bg-slate-800 overflow-hidden">
                  <div className="h-full bg-rose-500 rounded-full" style={{ width: '3.4%' }} />
                </div>
              </div>
              ...
              <div>
                <div className="flex justify-between text-slate-300 mb-1">
                  ...
                  <span className="text-cyan-400 font-bold">0.761</span>
                </div>
                <div className="h-2 w-full rounded-full bg-slate-800 overflow-hidden">
                  <div className="h-full bg-sky-400 rounded-full" style={{ width: '76.1%' }} />
                </div>
              </div>
            </div>
          </div>
